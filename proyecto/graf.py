...
# Crea todos los componentes del Frame de Registro
...
def createListRegistersWindow():
    ...
    btnEdit.place(x=250, y=50)
    btnRemove.place(x=250, y=100)
...
# Funcion para crear los elementos del Frame de registro
